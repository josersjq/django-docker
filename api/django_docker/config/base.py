...
STATICFILES_DIRS = [
    ("django_docker", os.path.join(BASE_DIR, "static")),
]
...
ADMINS = [("""Jojo San Juan""", "jojo@bld.ai")]
...
REDIS_URL_CACHE = env.cache("DJANGO_REDIS_URL", default="locmemcache://")
if REDIS_URL := env("DJANGO_REDIS_URL", default="redis://localhost:6379"):
...
CELERY_SOFT_TIME_LIMIT = 60

CELERY_BEAT_SCHEDULE = {}

CACHEOPS_REDIS = env("CACHEOPS_REDIS_URL", default="redis://localhost:6379")
CACHEOPS = {
    "procedures.ReferenceCard": {"ops": {"fetch", "get"}, "timeout": 60 * 60 * 24},
}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Django Docker API",
    "DESCRIPTION": "Documentation of API endpoints of Django Docker",
    "VERSION": "1.0.0",
